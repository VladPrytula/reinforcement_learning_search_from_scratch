...
::: {.note title="Assumptions (probability and RL foundations)"}
...
::: {.warning title="Practical anchor: importance weights"}
...
::: {.note title="Code <-> Config (position bias and satisfaction)"}
...
::: {.note title="Code <-> Behavior (Stopping Times & Satisfaction)"}
...
::: {.note title="Code <-> Theory (Complete Mapping for Utility-Based Cascade)"}
...
::: {.note title="Code <-> Env/Reward (session step and aggregation)"}
...
::: {.note title="Code <-> Theory (Tower Property)"}
...
::: {.note title="Code <-> Theory (Score Distribution)"}
...
::: {.tip title="Production Checklist (Chapter 2)"}
