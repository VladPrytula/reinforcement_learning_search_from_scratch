...
We enforce constraints via **Lagrangian methods** (formalism in Chapter 3 Section 3.6; convex duality background in Appendix C; implementation in Chapter 10) and **rank stability penalties**.
...
- **Chapter 10** (Guardrails): Production constraints---CM2 floors, \ensuremath{\Delta}Rank@k stability, safe fallback (CMDP theory in Section 3.6)
...
3. **Unmodeled constraints**: Real business has:
   ...
   - **Solution**: Constrained MDP (Section 3.5) with **Lagrangian relaxation**, implemented as guardrails in Chapter 10
...
- In Chapter 10, we'll implement production guardrails (CM2 floors, \ensuremath{\Delta}Rank@k) applying CMDP theory from Section 3.5
